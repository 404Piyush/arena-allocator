# Deployment — arena-allocator site
...
2. Pick **GitHub** → **404Piyush/arena-allocator**.
...
## Custom domain: arena-allocator.404piyush.me

In Netlify → **Site settings** → **Domain management** →
**Add custom domain** → `arena-allocator.404piyush.me`.
...
```
curl -I https://arena-allocator.404piyush.me
```
