...
A small, dependency-free **bump arena** memory allocator written
in C11. Single mmap, O(1) alloc and reset, no per-call overhead.
Designed for the common "allocate a bunch of stuff, throw it all
away at the end of the phase" pattern.
