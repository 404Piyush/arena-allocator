...
The arena-allocator C library is a small memory allocator.
It runs in the caller's process and does not parse untrusted
input, open files, or perform any I/O. The attack surface
is small.
